...
export function GetSearchToken(client, params, callback) {
    return __awaiter(this, void 0, void 0, function () {
        var appsCollection, hostsCollection, skip, limit, appsData, hostsData;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    appsData = _a.sent();
                    return [4 /*yield*/, hostsCollection.aggregate([
                            {
                                "$match": Object.assign({}, {
...
//# sourceMappingURL=functions-search.js.map